...
<img src="https://cdn.luogu.com.cn/upload/image_hosting/7h3jz5a2.png" style="zoom:100%;" />

而 $\vec{a}-\vec{b}$ 则相当于 $\vec{a}$ 加上 $\vec{b}$ 的相反向量，即 $\vec{a}+(-\vec{b})=(x_1-x_2,y_1-y_2)$。

![](https://cdn.luogu.com.cn/upload/image_hosting/wyyg987e.png)
...
\end{aligned}
$$
<img src="http://www.wjyyy.top/wp-content/uploads/2019/03/201903010907.png" alt="img" style="zoom:80%;" />
...
![img](https://pic1.zhimg.com/80/v2-0445f479fa0f352f95bfaaf0c1158888_720w.jpg)
...
<img src="https://img-blog.csdnimg.cn/116034bba05241c2b031ed142040fa58.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBARnJhbmtsaW4=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="img" style="zoom:50%;" />

至于对其正负的判断，可以通过右手定则来判断。

因此可以发现，当 $\vec a$ 处于 $\vec b$ 顺时针侧时，它们的叉积为负，反则为正。因此可以利用两向量叉积的正负来判断其相对位置关系。

![](https://img-blog.csdnimg.cn/20200715223045345.jpg?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80Mzc3MjE2Ng==,size_16,color_FFFFFF,t_70)
...
<img src="https://pic.imgdb.cn/item/62ae8cf10947543129fa65ff.png" style="zoom:80%;" />
...
<img src="https://img-blog.csdn.net/20180204142640286" alt="img" style="zoom:50%;" />

那么直到最后这根橡皮筋会被最外圈的钉子固定住，无法再往里缩。此时这个橡皮筋所构成的就是一个凸包。

<img src="https://img-blog.csdn.net/20180204142932069" alt="img" style="zoom:50%;" />
...
![](https://pic.imgdb.cn/item/62adbcff094754312919c3cd.png)
...
![2](https://pic.imgdb.cn/item/62adbcff094754312919c3d3.png)

按照排序后的顺序将所有点依次连接，可以得到一个多边形，但显然它不一定具有凸性（如下图）。

![3](https://pic.imgdb.cn/item/62adbcff094754312919c3de.png)
...
![4](https://pic.imgdb.cn/item/62adbcff094754312919c3ef.png)

此时栈中元素仅有两个，直接将 $P4$ 入栈。

![5](https://pic.imgdb.cn/item/62adbcff094754312919c401.png)

最终形成的凸包长这样：

![6](https://pic.imgdb.cn/item/62adbd6a09475431291a426f.png)

整个过程放一张动图大概是就是这样：

![](https://pic.imgdb.cn/item/62adce7f094754312930398b.gif)
...
![7](https://pic.imgdb.cn/item/62adbd6a09475431291a4281.png)

首先先将前两个点入栈（因为第一个点一定在凸包上，且栈中必须要两个点来形成向量以便比较，所以将第二个点也放进去，但第二个点不一定在凸包上，有可能以后会被弹出去）：

![8](https://pic.imgdb.cn/item/62adbd6a09475431291a4288.png)

然后发现 $P2$ 和 $P3$ 形成的向量在 $P1,P2$ 形成的向量的顺时针方向，入栈。

​           ![9](https://pic.imgdb.cn/item/62adbd6a09475431291a429f.png)                       ![10](https://pic.imgdb.cn/item/62adbd6a09475431291a426b.png)
...
![11](https://pic.imgdb.cn/item/62adbd6e09475431291a4932.png)

以此类推，我们顺利地得到了一个下凸壳：

![12](https://pic.imgdb.cn/item/62adbd6e09475431291a4938.png)

但是现在，遍历已经结束了，凸包却并没有完成构建，所以需要再从 $P7$ 开始，按照和刚刚一模一样的方法，从后往前遍历一遍，就可以得到一个完整的凸包了。

![13](https://pic.imgdb.cn/item/62adbd6e09475431291a4944.png)
...
![](https://pic.imgdb.cn/item/62aeab7409475431291c6719.png)

![](https://pic.imgdb.cn/item/62aeab7409475431291c6724.png)
...
![14](https://pic.imgdb.cn/item/62adbd6e09475431291a494b.png)

找最远点就相当于找到像下图所示的一对平行线使得它们刚好把整个凸包卡在中间：

![15](https://pic.imgdb.cn/item/62adbd6e09475431291a4958.png)
...
![](https://pic.imgdb.cn/item/62adce4709475431292ff02a.gif)
...
![16](https://pic.imgdb.cn/item/62adbd7209475431291a4ecd.png)
...
![17](https://pic.imgdb.cn/item/62adbd7209475431291a4ed7.png)

接下来求矩阵面积。

在如下矩形中，矩形的高是 $P_4$ 到 $P_2P_5$ 的距离，可以通过使用叉乘求出三角形 $P_4P_2P_5$ 的面积，则矩形的高就是 $\frac{S_{\triangle\ P_4P_2P_5}}{2P_2P_5}$ 。

![18](https://pic.imgdb.cn/item/62adbd7209475431291a4ee0.png)
...
<img src="https://pic.imgdb.cn/item/62ae9495094754312902cf44.png" style="zoom:80%;" />
...
<img src="https://pic.imgdb.cn/item/62ae96260947543129048c87.png" style="zoom:80%;" />
...
<img src="https://pic.imgdb.cn/item/62ae97da0947543129066226.png" style="zoom:80%;" />
...
<img src="https://pic.imgdb.cn/item/62ae9b6e094754312909fe52.png" style="zoom:80%;" />
...
<img src="https://pic.imgdb.cn/item/62aea31d0947543129130f61.png" style="zoom:50%;" /> <img src="https://pic.imgdb.cn/item/62aea31d0947543129130f84.png" style="zoom:50%;" />

接着计算 $S_{\triangle OCD}$，此时**抵消** $-S_{\triangle OCG}$，**并额外加上正的** $S_{\triangle GCD}$。

<img src="https://pic.imgdb.cn/item/62aea31d0947543129130f8d.png" style="zoom:80%;" />

重复上述过程：

<img src="https://pic.imgdb.cn/item/62aea459094754312914a04d.png" style="zoom:50%;" /> <img src="https://pic.imgdb.cn/item/62aea459094754312914a056.png" style="zoom:50%;" /> 

<img src="https://pic.imgdb.cn/item/62aea459094754312914a05b.png" style="zoom:50%;" /> <img src="https://pic.imgdb.cn/item/62aea459094754312914a063.png" style="zoom:50%;" />
